...
ช่วงนี้ผมสนุกกับการใช้ [Coding Agent](https://github.com/google-gemini/gemini-cli) มากครับ ลองนึกภาพว่ามันคือ "ผู้ช่วยเชฟ" แทนที่จะแค่บอกสูตรอาหารเหมือน [chatbot](https://chatgpt.com) ทั่วไป เจ้าเอเจนท์ตัวนี้จะลงมือหั่นผัก เปิดเตา และทำอาหารให้เราจนเสร็จ เพียงแค่เราบอกความต้องการ มันทำงานผ่าน `terminal` สามารถอ่านไฟล์ เขียนโค้ด และแก้ `bug` ได้เองจนจบงาน
